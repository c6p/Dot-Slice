...
export class UIScene extends Phaser.Scene {
  ...
  // TODO menu: main (play->level select), level select (levels, main menu), game (restart level, level select, main menu)
  create() {
    ...
    this.game.target = this.add.rectangle(0,0,10,40,0xffffff).setOrigin(0.5,0);
    this.game.progressBar = this.add.group([bg, this.game.progress, this.game.target]).setVisible(false);
